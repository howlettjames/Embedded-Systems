...
int main( )
{
	...
	//El segundo parametro indica que la pagina puede ser de lectura y escritura
	//El tercer parametro indica que las modificaciones al mapa seran visibles a otros procesos
	//El cuarto parametro es el manejador de lamemoria fisica
	//El quinto parametro es el offset
        ...
        //Se configura el BCM GPIO17 como salida
        *(gpio + 1) = (*(gpio + 1) & ~(7 << 21)) | (1 << 21);

        while(1){
                //Se pone en uno el GPIO 17
                *(gpio + 7) = (1 << 17);

            //    sleep(1);

                //Se pone en ceroel GPIO 17
